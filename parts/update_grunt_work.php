<?php
	...
	$new_user_query = 'INSERT IGNORE INTO Users (username,nickname,email) VALUES (?,?,?)';
	$new_user_results = $thisDatabaseWriter->update($new_user_query, $new_user_data, 0, 0, 0, 0, true);
